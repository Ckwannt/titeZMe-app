    ...
    <footer className="bg-[#050505] py-12 px-6">
       <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6 pb-12 border-b border-[#1E1E1E] mb-8">
          ...
          <div className="flex gap-4">
             <a href="https://www.instagram.com/titezme.es/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color: '#555', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'color 0.15s' }}>
             ...
             <a href="https://www.tiktok.com/@titezme" target="_blank" rel="noopener noreferrer" aria-label="TikTok" style={{ color: '#555', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'color 0.15s' }}>
