      ...
      <section className="bg-[#111] py-24 px-6 min-h-screen">
        <div className="max-w-[800px] mx-auto text-left">
          ...
          <div className="text-gray-300 space-y-12 leading-relaxed">
            ...
            <div>
              <h2 className="text-xl font-black text-white mb-4">SECTION 1 — Acceptance of Terms</h2>
            ...
            <div>
              <h2 className="text-xl font-black text-white mb-4">SECTION 2 — Description of Service</h2>
            ...
            <div>
              <h2 className="text-xl font-black text-white mb-4">SECTION 3 — User Accounts</h2>
              
              <h3 className="text-lg font-bold text-white mt-6 mb-2">3.1 Eligibility:</h3>
              ...
              <h3 className="text-lg font-bold text-white mt-6 mb-2">3.2 Account responsibility:</h3>
              ...
              <h3 className="text-lg font-bold text-white mt-6 mb-2">3.3 One account per person:</h3>
            ...
            <div>
              <h2 className="text-xl font-black text-white mb-4">SECTION 4 — Booking Rules</h2>
              
              <h3 className="text-lg font-bold text-white mt-6 mb-2">4.1 For clients:</h3>
              <ul className="list-disc pl-5 space-y-2 text-gray-400 mb-4">
              ...
              <h3 className="text-lg font-bold text-white mt-6 mb-2">4.2 For barbers:</h3>
              <ul className="list-disc pl-5 space-y-2 text-gray-400 mb-4">
              ...
              <h3 className="text-lg font-bold text-white mt-6 mb-2">4.3 Disputes:</h3>
            ...
            <div>
              <h2 className="text-xl font-black text-white mb-4">SECTION 5 — Prohibited Conduct</h2>
            ...
            <div>
              <h2 className="text-xl font-black text-white mb-4">SECTION 6 — Content and Reviews</h2>
              
              <h3 className="text-lg font-bold text-white mt-6 mb-2">6.1 Your content:</h3>
              ...
              <h3 className="text-lg font-bold text-white mt-6 mb-2">6.2 Reviews:</h3>
              ...
              <h3 className="text-lg font-bold text-white mt-6 mb-2">6.3 Prohibited content:</h3>
            ...
            <div>
              <h2 className="text-xl font-black text-white mb-4">SECTION 7 — Platform Fees</h2>
              
              <h3 className="text-lg font-bold text-white mt-6 mb-2">7.1 Beta period:</h3>
              ...
              <h3 className="text-lg font-bold text-white mt-6 mb-2">7.2 Future fees:</h3>
              ...
              <h3 className="text-lg font-bold text-white mt-6 mb-2">7.3 Payment:</h3>
            ...
            <div>
              <h2 className="text-xl font-black text-white mb-4">SECTION 8 — Intellectual Property</h2>
            ...
            <div>
              <h2 className="text-xl font-black text-white mb-4">SECTION 9 — Limitation of Liability</h2>
            ...
            <div>
              <h2 className="text-xl font-black text-white mb-4">SECTION 10 — Governing Law</h2>
            ...
            <div>
              <h2 className="text-xl font-black text-white mb-4">SECTION 11 — Changes to Terms</h2>
            ...
            <div>
              <h2 className="text-xl font-black text-white mb-4">SECTION 12 — Contact</h2>
              <p className="mb-2">For questions about these Terms:</p>
              <p className="font-bold">
                titeZMe Legal Team<br/>
                Email: <a href="mailto:legal@titezme.com" className="text-brand-yellow hover:underline">legal@titezme.com</a><br/>
