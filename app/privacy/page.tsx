      ...
      <section className="bg-[#111] py-24 px-6 min-h-screen">
        <div className="max-w-[800px] mx-auto text-left">
          ...
          <div className="text-[#888580] space-y-12 leading-relaxed">
            ...
            <div>
              <h2 className="text-xl font-black text-[#F0EDE8] mb-4">SECTION 2 — Information We Collect</h2>
              
              <h3 className="text-lg font-bold text-[#F0EDE8] mt-6 mb-3">2.1 Information you provide directly:</h3>
              ...
              <h3 className="text-lg font-bold text-[#F0EDE8] mt-6 mb-3">2.2 Information collected automatically:</h3>
              <ul className="list-disc pl-5 space-y-2 text-[#888580]">
              ...
              <h3 className="text-lg font-bold text-[#F0EDE8] mt-6 mb-3">2.3 Information from third parties:</h3>
              <ul className="list-disc pl-5 space-y-2 text-[#888580]">
            ...
            <div>
              <h2 className="text-xl font-black text-[#F0EDE8] mb-4">SECTION 3 — How We Use Your Information</h2>
              ...
              <p className="font-bold text-[#FFD600]">We do NOT sell your personal data to third parties. Ever.</p>
            </div>

            <div>
              <h2 className="text-xl font-black text-[#F0EDE8] mb-4">SECTION 4 — How We Share Your Information</h2>
              
              <h3 className="text-lg font-bold text-[#F0EDE8] mt-6 mb-2">4.1 With other users:</h3>
              ...
              <h3 className="text-lg font-bold text-[#F0EDE8] mt-6 mb-2">4.2 Barber public profiles:</h3>
              ...
              <h3 className="text-lg font-bold text-[#F0EDE8] mt-6 mb-2">4.3 Service providers:</h3>
              ...
              <h3 className="text-lg font-bold text-[#F0EDE8] mt-6 mb-2">4.4 Legal requirements:</h3>
              <p>We may disclose your information if required by law, court order, or governmental authority.</p>
            </div>

            <div>
              <h2 className="text-xl font-black text-[#F0EDE8] mb-4">SECTION 5 — Data Retention</h2>
            ...
            <div>
              <h2 className="text-xl font-black text-[#F0EDE8] mb-4">SECTION 6 — Your Rights (GDPR)</h2>
              ...
              <p>To exercise these rights, contact us at: <a href="mailto:privacy@titezme.com" className="text-[#FFD600] font-bold hover:underline">privacy@titezme.com</a><br/>We will respond within 30 days.</p>
            </div>

            <div>
              <h2 className="text-xl font-black text-[#F0EDE8] mb-4">SECTION 7 — Cookies</h2>
            ...
            <div>
              <h2 className="text-xl font-black text-[#F0EDE8] mb-4">SECTION 8 — Children&apos;s Privacy</h2>
            ...
            <div>
              <h2 className="text-xl font-black text-[#F0EDE8] mb-4">SECTION 9 — Security</h2>
            ...
            <div>
              <h2 className="text-xl font-black text-[#F0EDE8] mb-4">SECTION 10 — International Transfers</h2>
            ...
            <div>
              <h2 className="text-xl font-black text-[#F0EDE8] mb-4">SECTION 11 — Changes to This Policy</h2>
            ...
            <div>
              <h2 className="text-xl font-black text-[#F0EDE8] mb-4">SECTION 12 — Contact Us</h2>
              <p className="mb-2">For any privacy-related questions or requests:</p>
              <p className="font-bold">
                titeZMe Privacy Team<br/>
                Email: <a href="mailto:privacy@titezme.com" className="text-[#FFD600] hover:underline">privacy@titezme.com</a><br/>
