    ...
    <div className="bg-[#0A0A0A] text-white pt-24 min-h-screen font-sans">
        ...
        <div className="flex flex-col lg:flex-row gap-20">
          <div className="flex-1 animate-fadeUp">
            <div className="inline-flex items-center gap-2 border border-[#2a2a2a] rounded-full px-3 py-1 mb-8">
              ...
              <span className="text-xs font-bold text-gray-500">2,400+ barbers Â· 18 cities Â· live now</span>
            </div>
            ...
            <p className="text-lg text-gray-400 font-bold mb-10 max-w-[480px] leading-relaxed">
              Top-rated barbers in your city. Real availability. Cash only â€” no fees, no apps, no nonsense. Book in under 30 seconds.
            </p>
            ...
            <div className="bg-[#0f0f0f] border border-[#2a2a2a] p-2 rounded-2xl flex flex-col md:flex-row gap-2 mb-6">
              <div className="flex-1 flex items-center px-4 py-2 border-b md:border-b-0 md:border-r border-[#2a2a2a]">
                <span className="text-xl mr-3 opacity-50">â˜</span>
              ...
              <div className="flex-1 flex items-center px-4 py-2">
                <span className="text-xl mr-3 opacity-50">â˜</span>
                <input type="text" placeholder="Specialty â€” Skill" className="bg-transparent w-full text-white font-bold outline-none placeholder:text-gray-600"/>
              </div>
            ...
            {featuredBarber ? (
              <div className="bg-[#141414] border border-[#2a2a2a] rounded-3xl p-6 relative overflow-hidden">
                <div className="flex justify-between items-start mb-6">
                   ...
                   <div className="flex flex-col items-end">
                      <div className="text-brand-yellow font-black">â˜… {featuredBarber.rating?.toFixed(2) || '4.97'}</div>
              ...
              <div className="bg-[#141414] border border-[#2a2a2a] rounded-3xl p-6 relative overflow-hidden flex flex-col justify-between" style={{ minHeight: '400px'}}>
                  <div className="flex justify-between items-start mb-6">
                   ...
                   <div className="flex flex-col items-end">
                      <div className="text-brand-yellow font-black">â˜… 4.97</div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="bg-[#141414] border border-[#2a2a2a] rounded-2xl p-4 flex gap-3 items-center">
                ...
                <div>
                  ...
                  <div className="text-[10px] font-bold text-gray-500">â˜… 4.9 â€¢ 80 MAD</div>
                </div>
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-6">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-black">
                {browserCity} <span className="text-gray-500 font-bold">â€” {barbers.length > 0 ? barbers.length : 'X'} available</span>
              </h2>
            </div>
              ...
              barbers.slice(0,6).map((item: any, i) => (
                ...
                <div className="h-[200px] bg-[#1a1a1a] relative">
                  {item.photos && item.photos.length > 0 ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center text-5xl">ðŸ’ˆ</div>
                  )}
                  {item.isOpenToday ? (
                  ...
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="flex flex-col items-end">
                      <div className="flex items-center gap-1 font-black text-brand-yellow text-sm">
                        <span>â˜…</span> {item.rating > 0 ? item.rating.toFixed(1) : 'New'}
                      </div>
        ...
        <div className="max-w-[1200px] mx-auto">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
               {[
                 ...
                 <div key={i} className="bg-[#111] border border-[#2a2a2a] p-6 rounded-3xl flex flex-col justify-between">
                   <div>
                     <div className="flex gap-1 text-brand-yellow mb-4 text-xs">â˜…â˜…â˜…â˜…â˜…</div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12 bg-[#111] border border-[#2a2a2a] p-6 rounded-3xl">
             ...
             <div className="flex flex-col items-center justify-center border-r border-[#2a2a2a]/50 px-4 w-full">
               <div className="w-full flex items-center gap-2 mb-1"><span className="text-[10px] text-gray-500">5â˜…</span><div className="h-1.5 flex-1 bg-[#2a2a2a] rounded-full overflow-hidden"><div className="w-[87%] h-full bg-brand-yellow"></div></div></div>
               <div className="w-full flex items-center gap-2 mb-1"><span className="text-[10px] text-gray-500">4â˜…</span><div className="h-1.5 flex-1 bg-[#2a2a2a] rounded-full overflow-hidden"><div className="w-[10%] h-full bg-brand-yellow opacity-50"></div></div></div>
               <div className="w-full flex items-center gap-2"><span className="text-[10px] text-gray-500">3â˜…</span><div className="h-1.5 flex-1 bg-[#2a2a2a] rounded-full overflow-hidden"><div className="w-[3%] h-full bg-brand-yellow opacity-25"></div></div></div>
             </div>
             <div className="flex flex-col items-center justify-center border-r border-[#2a2a2a]/50">
      ...
      <section id="how-it-works" className="bg-[#0A0A0A] py-32 px-6">
         ...
         <div className="max-w-[1200px] mx-auto grid md:grid-cols-3 gap-12 lg:gap-20">
            {[
              { n: '01', t: 'Pick your city', d: 'Open the app on any device or browser. We detect your location automatically, or choose your city and availability.', i: 'ðŸ“' },
              { n: '02', t: 'Choose your barber', d: "Filter by specialty, language, vibe, price. See who's open right now in real time this very minute.", i: 'âœ‚ï¸' },
              { n: '03', t: 'Show up. Pay cash.', d: 'Book in under 30 seconds. Arrive, get the cut you chose directly. Zero drama. 100% real.', i: 'ðŸ’µ' }
            ].map((step, i) => (
        ...
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-[1.2fr_1fr] gap-16 lg:gap-8 items-center">
          <div>
            ...
            <div className="flex flex-col gap-4 mb-10">
              {['0% commission â€” keep every dirham/euro', 'Profile live in under 10 minutes', 'Your own schedule â€” no one owns your time', 'Clients find you â€” you just cut'].map((text, i) => (
                <div key={i} className="flex gap-3 items-start">
                  <div className="w-6 h-6 rounded-full bg-brand-yellow/10 flex items-center justify-center shrink-0 mt-0.5">
                    <span className="text-brand-yellow text-xs font-black">âœ“</span>
                  </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
               {[
                 ...
                 <div key={i} className={`p-6 rounded-3xl border transition-colors ${city.b ? 'bg-[#111] border-[#2a2a2a] hover:border-brand-yellow/50' : 'bg-[#0f0f0f] border-[#1a1a1a] opacity-60'}`}>
                    ...
                    {city.b ? (
                      <button className="text-sm font-black text-brand-yellow">Explore â†’</button>
                    ) : (
                      <button className="text-sm font-bold text-gray-600">Request it â†’</button>
                    )}
                 </div>
               ))}
            </div>
